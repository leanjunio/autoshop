    ...
    <div className="h-screen">
      ...
      <section className="bg-gray-50 sm:h-4/6">
        <div className="flex flex-col w-full justify-center items-center">
          ...
          <div className="grid grid-rows-6 grid-cols-1 md:grid-rows-2 md:grid-cols-3 md:px-40 w-3/4 text-center">
            <div className="flex flex-col md:p-10">
              <FiDollarSign className="mb-5 w-full text-accent" size={40} />
            ...
            <div className="flex flex-col p-10">
              <FiHeart className="mb-5 w-full text-accent" size={40} />
            ...
            <div className="flex flex-col p-10">
              <FiShield className="mb-5 w-full text-accent" size={40} />
            ...
            <div className="flex flex-col p-10">
              <FiGlobe className="mb-5 w-full text-accent" size={40} />
            ...
            <div className="flex flex-col p-10">
              <FiAward className="mb-5 w-full text-accent" size={40} />
            ...
            <div className="flex flex-col p-10">
              <FiClock className="mb-5 w-full text-accent" size={40} />
